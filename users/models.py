...
class UserAuth(AbstractBaseUser):
    ...
    def is_org(self):
        g = Group.objects.get(name="org")
        return g in self.groups.all()
...
class Profile(models.Model):
    ...
    def reports_over_years(self):
        return self.reports.order_by('-year')
...
class Report(models.Model):
    ...
    def set_authors(self, author_ids):
        # current
        current_authors = self.authors.values_list("id", flat=True)
