...
urlpatterns = [
    ...
    path('author_endpoint/', views.author_endpoint, {'advisor' : False},   name="author_endpoint"),
    path('author_endpoint/<uuid:author_id>/', views.author_endpoint, {'advisor' : False}, name="author_endpoint"),
    path('author_endpoint/get_form/', views.author_endpoint, {'advisor' : False}, name="author_endpoint_form"),
    path('author_endpoint/get_form/<uuid:author_id>/', views.author_endpoint, {'advisor' : False}, name="author_endpoint_form"),
    path('delete_author/<uuid:author_id>/', views.delete_author, name="delete_author"),

    path('advisor_endpoint/', views.author_endpoint, {'advisor' : True}, name="advisor_endpoint"),
    path('advisor_endpoint/<uuid:author_id>/', views.author_endpoint, {'advisor' : True}, name="advisor_endpoint"),
    path('advisor_endpoint/get_form/', views.author_endpoint, {'advisor' : True}, name="advisor_endpoint_form"),
    path('advisor_endpoint/get_form/<uuid:author_id>/', views.author_endpoint, {'advisor' : True}, name="advisor_endpoint_form"),
