...
def filter_participants(request, year):
    ...
    print("citizenship from query", citizenship)
    print("online from query", online)
    print("reports from query", reports)
...
def filter_reports(request, year):
    ...
    citizenship = request.GET.get('citizenship', None)
    online = request.GET.get('online', None)
    print("section_id from query", section_id)
    print("citizenship from query", citizenship)
    print("online from query", online)
    print("status", status)
...
def report_chat(request, report_id, comment_id=None, **kwargs):
    ...
    print("got report", report_instance.id) 
    ...
    print(comment_instance, "comment")
